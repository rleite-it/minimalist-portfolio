...
export default function Footer() {
    return (
        <footer className="mt-28 static py-11 w-[1024px] min-h-16 flex items-center justify-between text-[15px]">
            <span className="text-zinc-500">Design credits - <Link to="https://www.figma.com/@feyza" className="underline transition-colors hover:text-zinc-950">Feyza Okumus</Link></span>
